...
<body>
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <main id="main" class="main">
            ...
            <form action="{{url('alergi')}}" method="POST">
                @csrf
            ...
            <div class="row mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea class="form-control" style="height: 100px" required name="alergi"></textarea>
                </div>
              </div>
                  ...
                  <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <td>{{ $data->alergi }}</td>
                            <td>
                                <a class="btn btn-warning btn-sm" href="{{url('alergi/'.$data->id.'/edit')}}"><i class="bi bi-pencil-square"></i></a>
                                <form  action="{{ url('alergi/'.$data->id) }}" method="POST">
                                    @csrf
                                    <input type="hidden" name="_method" value="DELETE">
                                    <button class="btn btn-danger btn-sm" type="submit" title="Delete Contact" onclick="return confirm(&quot;Confirm delete?&quot;)" ><i class="bi bi-eraser"></i></button>
                                </form>
                                </td>
