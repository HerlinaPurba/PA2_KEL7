    ...
    <aside id="sidebar" class="sidebar">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
              <a class="nav-link" data-bs-target="#icons-nav" data-bs-toggle="collapse" href="#">
                <i class="bi bi-file-earmark-word-fill"></i><span>Data Dorm</span><i class="bi bi-chevron-down ms-auto"></i>
              </a>
        ...
        <main id="main" class="main">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                Data mahasiswa sakit, mohon diisi dengan teliti dan lengkap!
