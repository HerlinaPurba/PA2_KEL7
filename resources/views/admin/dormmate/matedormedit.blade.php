        ...
        <div class="row">
            ...
            <input type="text" class="form-control" name="prodi" value="{{$model->prodi}}">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="prodi" required
                                            value="{{ $model->prodi }}">
                                            <option selected disabled value="">Pilih..</option>
                                            <option value="D3 TI" {{ $model->prodi == 'D3 TI' ? 'selected' : '' }}>D3
                                                Teknologi Informasi</option>
                                            <option value="D3 TK" {{ $model->prodi == 'D3 TK' ? 'selected' : '' }}>D3
                                                Teknologi Komputer</option>
                                            <option value="D4 TRPL" {{ $model->prodi == 'D4 TRPL' ? 'selected' : '' }}>
                                                D4 Teknologi Rekayasa Perangkat Lunak</option>
                                            <option value="S1 SI" {{ $model->prodi == 'S1 SI' ? 'selected' : '' }}>S1
                                                Sistem Informasi</option>
                                            <option value="S1 IF" {{ $model->prodi == 'S1 IF' ? 'selected' : '' }}>S1
                                                Informatika</option>
                                            <option value="S1 TE" {{ $model->prodi == 'S1 TE' ? 'selected' : '' }}>S1
                                                Teknik Elektro</option>
                                            <option value="S1 MR" {{ $model->prodi == 'S1 MR' ? 'selected' : '' }}>S1
                                                Manajemen Rekayasa</option>
                                            <option value="S1 BP" {{ $model->prodi == 'S1 BP' ? 'selected' : '' }}>S1
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="gender"
                                            ...
                                            <option value="Perempuan"
                                                {{ $model->gender == 'Perempuan' ? 'selected' : '' }}>Perempuan
                                            </option>
                                            <option value="Laki-laki"
                                                {{ $model->gender == 'Laki-laki' ? 'selected' : '' }}>Laki-laki
                                            </option>
                                        </select>
                                    </div>
                                </div>
