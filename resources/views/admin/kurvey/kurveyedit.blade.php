                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <select class="form-select" id="validationDefault04" name="prodi2" required>
                                            ...
                                            <option value="D3 TI" {{ $model->prodi2 == 'D3 TI' ? 'selected' : '' }}>D3
                                                Teknologi Informasi</option>
                                            <option value="D3 TK" {{ $model->prodi2 == 'D3 TK' ? 'selected' : '' }}>D3
                                                Teknologi Komputer</option>
                                            <option value="D4 TRPL"
                                                {{ $model->prodi2 == 'D4 TRPL' ? 'selected' : '' }}>D4 Teknologi
                                                Rekayasa Perangkat Lunak</option>
                                            <option value="S1 SI" {{ $model->prodi2 == 'S1 SI' ? 'selected' : '' }}>S1
                                                Sistem Informasi</option>
                                            <option value="S1 IF" {{ $model->prodi2 == 'S1 IF' ? 'selected' : '' }}>S1
                                                Informatika</option>
                                            <option value="S1 TE" {{ $model->prodi2 == 'S1 TE' ? 'selected' : '' }}>S1
