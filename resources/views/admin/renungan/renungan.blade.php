    ...
    <aside id="sidebar" class="sidebar">
        ...
        <main id="main" class="main">
            ...
            <div class="alert alert-warning alert-dismissible fade show" role="alert">
                ...
                Penambahan data Renungan, mohon diisi dengan teliti dan lengkap!
                  ...
                  <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            ...
                            <td>
                                <a class="btn btn-warning btn-sm" href="{{url('renungan/'.$data->id.'/edit')}}"><i class="bi bi-pencil-square"></i></a>
