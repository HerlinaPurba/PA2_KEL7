          ...
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>Dorm Info</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                ...
                <li><a href="renungan">Renungan Asrama</a></li>
            ...
            <li><a class="nav-link scrollto" href="logout"><button type="button" class="btn btn-danger">Logout</button></a></li>
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Seluruh mahasiswa IT Del diwajibkan tinggal di asrama yang disediakan. Hal ini untuk mendukung sistem pendidikan vokasi dimana mahasiswa akan melaksanakan kegiatan akademis terjadwal sampai sore hari ditambah kegiatan mandiri hingga pukul 10 malam hari.
            Dengan tinggal di asrama yang lokasinya berada di dalam lingkungan kampus, mahasiswa dapat segera beristirahat setelah melaksanakan kegiatan terjadwal di kampus. Dengan beristirahat yang cukup dan baik diharapkan performansi mahasiswa dalam setiap kegiatan di dalam kampus akan maksimal.
          </p>
        </div>
        ...
        <div class="col-lg-6">
          ...
          <ul align="justify">
            ...
            <li><i class="ri-check-double-line"></i> Membuat rencana program Asrama (kalender Kegiatan Keasramaan)  untuk jangka pendek, jangka menengah dan jangka panjang;</li>
                    <li><i class="ri-check-double-line"></i> Memberikan arahan job description kepada Bapak-Ibu Pembina Asrama untuk mengelola masing -masing Asrama;</li>
                    <li><i class="ri-check-double-line"></i> Melakukan koordinasi dengan berbagai pihak yang terlibat dalam pengelolaan Asrama (termasuk dengan dosen wali, dosen matakuliah, satpam, pihak kantin dan lain-lain);</li>
                    <li><i class="ri-check-double-line"></i> Mengatur dan mengkoordinasikan sistem pelayanan asrama yang berhubungan dengan aktivitas dan pengembangan kegiatan Asrama;</li>
                    <li><i class="ri-check-double-line"></i> Memantau dan mengevaluasi kelangsungan program pada struktur;</li>
                    <li><i class="ri-check-double-line"></i> Mengeluarkan kebijakan pengelolaan asrama, disesuaikan dengan kondisi di asrama;</li>
 ...
 <section id="services" class="services section-bg">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
          <div class="icon-box iconbox-blue">
            ...
            <p>Aturan yang berlaku pada seluruh asrama Institut Teknologi Del dilengkapi dengan tingkat pelanggaran dan poin yang berlaku</p>
          </div>
        </div>
   ...
   <section id="keterangan" class="faq section-bg">
    <div class="container" data-aos="fade-up">
      ...
      <div class="faq-list">
        <ul>
          <li data-aos="fade-up">
            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Bagaimana ketentuan pengolaan waktu yang baik dalam Kampus? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
              <p>
                <ul>
                    <li>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Mahasiswa diharapkan memanfaatkan jam akademik dan jam kolaboratif untuk berada
                            di dalam lingkungan kampus IT Del untuk melakukan kegiatan akademik, kegiatan pendukung akademik,
                            serta kegiatan pengembangan diri dan organisasi.
                        </p>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Mahasiswa diharapkan dapat memanfaatkan periode dimana mahasiswa diijinkan berada diluar kampus,
                            yaitu pukul 17.00 - 19.00 WIB dihari Senin sampai Jumat dan diakhir pekan, untuk melakukan kegiatan non-akademik
                            seperti mengambil uang ke ATM.
                        </p>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Mahasiswa diharapkan dapat memeriksa dan membawa kelengkapan sebelum meninggalkan asrama, seperti: laptop, charger, buku, dan lainnya.
                        </p>
                        <p>
                            <i class="bi bi-exclamation-triangle-fill"></i>     Dengan melakukan ketiga hal tersebut di atas maka mahasiswa <b>TIDAK DIIJINKAN</b> untuk melakukan kegiatan
                            non akademik seperti yang disebutkan pada butir <b>(2)</b> dan kembali ke asrama karena lupa membawa keperluan yang disebut pada butir <b>(3)</b> di atas pada jam akademik dan
                            jam kolaboratif kecuali untuk hal yang <b>SANGAT MENDESAK</b>, dan atas persetujuan Koordinator Kemahasiswaan dan Koordinator Keasramaan.
                        </p>
                    </li>
                </ul>
              </p>
          ...
          <li data-aos="fade-up" data-aos-delay="100">
            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Bagaimana ketentuan Izin Keluar Kampus? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <ul>
                    <li>
                        <p>
                            <i class="bi bi-balloon"></i>   Mahasiswa diperkenankan keluar kampus setelah jam perkuliahan pada hari Senin-Jumat
                        ...
                        <p>
                            <i class="bi bi-balloon"></i>   IK pada jam akademik dilakukan melalui CIS dengan persetujuan Dosen Wali, Dosen
                        ...
                        <p>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p>
                                        Minggu : 07.00 -14.00 WIB (Makan Pagi dan Makan Siang tidak disediakan di Kantin)
                                    </p>
                                </li>
                            </ul>
          ...
          <li data-aos="fade-up" data-aos-delay="200">
            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-3" class="collapsed">Bagaimana ketentuan Izin Bermalam? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            <div id="faq-list-3" class="collapse" data-bs-parent=".faq-list">
                <ul>
                    <li>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  IB dilakukan H-2 dengan mengisi : <a href ="https://cis.del.ac.id/askm/izin-bermalam/izin-by-mahasiswa-add">Form Izin Bermalam</a>
                            Dan mencetak form IBL untuk ditandatangani Bapak/Ibu Asrama dan ditunjukan di Pos Satpam saat keluar kampus.
                        </p>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Mahasiswa diberikan Izin Bermalam di Luar Kampus (IBL) di hari Jumat atau Sabtu atau di hari lain dimana keesokan harinya tidak ada kegiatan akademik atau kegiatan lainnya yang tidak mengharuskan mahasiswa berada di kampus IT Del.
                        </p>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Pada saat kembali ke kampus, mahasiswa mengumpulkan kertas IBL yang telah ditandatangani oleh orangtua di Pos Satpam untuk selanjutnya dikumpulkan dan direkap oleh Pembina Asrama.
                        </p>
                        <p>
                            <i class="bi bi-balloon-fill"></i>  Apabila terdapat kegiatan Badan Eksekutif Mahasiswa (BEM) yang mengharuskan seluruh mahasiswa mengikuti kegiatan tersebut, maka mahasiswa tidak diperbolehkan IBL.
                        </p>
                        <p>
                            <i class="bi bi-exclamation-triangle-fill"></i>     Mahasiswa yang tidak mengajukan IBL sesuai ketentuan pada butir 3 (tiga) <b>tidak diizinkan untuk IBL</b> kecuali dalam kondisi mendesak (emergency) seperti sakit atau ada keluarga meninggal
                        </p>
                    </li>
                </ul>
            </div>
          ...
          <li data-aos="fade-up" data-aos-delay="300">
            <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-4" class="collapsed">Apa Sanksi jika melakukan Izin Keluar Kampus, Kelas dan Izin Bermalam tanpa keterangan? <i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
            <div id="faq-list-4" class="collapse" data-bs-parent=".faq-list">
              <ul>
                <li>
                    <p>
                        <i class="bi bi-emoji-frown-fill"></i>  Tidur di luar asrama tanpa sepengetahuan/izin dari Pembina Asrama atau IBL secara gelap mendapatkan poin <b>20</b> dan termasuk pelanggaran <b>sedang</b>
                    </p>
                    <p>
                        <i class="bi bi-emoji-frown-fill"></i>  Meninggalkan kelas/jam pelajaran tanpa izin mendapatkan poin <b>5</b> dan termasuk pelanggaran <b>ringan</b>
                    </p>
                </li>
              </ul>
            </div>
  ...
  <section id="contact" class="contact">
    <div class="container" data-aos="fade-up">
      ...
      <div>
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15945.455082679036!2d99.1384086390879!3d2.384449515907751!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x302e00fdad2d7341%3A0xf59ef99c591fe451!2sDel%20Institute%20of%20Technology!5e0!3m2!1sen!2sid!4v1683770829916!5m2!1sen!2sid" width="1300" height="270" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </div>
...
<footer id="footer">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 footer-links">
          ...
          <ul>
            <li><i class="bx bx-chevron-right"></i> <a href="https://www.del.ac.id/?page_id=144">Kantin IT - Del</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="https://www.del.ac.id/?page_id=142">Guest House</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="https://www.del.ac.id/?page_id=142">Town House</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="https://www.del.ac.id/?page_id=142">Mansionette</a></li>
            <li><i class="bx bx-chevron-right"></i> <a href="https://www.del.ac.id/?page_id=142">Studio</a></li>
          </ul>
        </div>
  ...
  <div class="container d-md-flex py-4">
    ...
    <div class="social-links text-center text-md-right pt-3 pt-md-0">
      ...
      <a href="https://www.facebook.com/profile.php?id=403538753086034&fref=ts" class="facebook"><i class="bx bxl-facebook"></i></a>
      <a href="https://www.instagram.com/it.del/?hl=en" class="instagram"><i class="bx bxl-instagram"></i></a>
