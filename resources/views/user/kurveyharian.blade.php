 ...
 <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="alert alert-info" role="alert">
            <b>Jadwal Kurve Harian Asrama</b>
          </div>
  ...
  <div class="section-title">
    <h2>Kurve Massal</h2>
    <p>Kurve Massal Institut Teknologi Del dilakukan setiap apabila ingin menyambut libur yang panjang dan kegiatan ini memiliki tujuan agar kampus ditinggalkan dengan keadaan bersih.</p><br>
