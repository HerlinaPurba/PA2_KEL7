...
<!-- ======= Sidebar ======= -->
    ...
    <main>
        <section class="section">
            <div class="card">
            <div class="card-body">
                <h5 class="card-title">Renungan Harian Asrama</h5>
                <a class="btn btn-primary" href="beranda" role="button">Kembali</a>
                <button class="btn btn-warning" type="">Download</button>
                <br>
                ...
                <thead>
                    ...
                    <th scope="col">Renungan Pagi</th>
                    <th scope="col">Renungan Malam</th>
