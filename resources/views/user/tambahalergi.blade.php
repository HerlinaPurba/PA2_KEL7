                        ...
                        <div class="card-body">
                            ...
                            <form class="row g-3" action="{{ route('simpanuser') }}" method="POST"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="" class="form-control" name="nim"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea type="text" class="form-control" name="alergi" required></textarea>
                                </div>

                                <div class="col-md-6">
                                    <label for="" class="form-label">Surat Keterangan Alergi</label>
                                    <input type="file" class="form-control" name="bukti" id="img_file" required>
                                </div>
