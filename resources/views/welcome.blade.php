        ...
        <nav id="navbar" class="navbar">
          <ul>
            ...
            <li class="dropdown"><a href="#"><span>About Dormitory</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="#about">Profile Keasramaan</a></li>
                <li class="dropdown"><a href="#services"><span>Rules of Dormitory</span> <i class="bi bi-chevron-down"></i></a>
                  <ul>
                    ...
                    <li><a href="#rusun1">Rusunawa 2</a></li>
                    <li><a href="#rusun1">Rusunawa 3</a></li>
            ...
            {{-- <li class="dropdown"><a href="#"><span>Dorm Info</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                ...
                <li><a href="#kurvey">Jadwal Kurvey</a></li>
            ...
            <li class="dropdown"><a href="#"><span>Data Dorm</span> <i class="bi bi-chevron-down"></i></a>
              <ul>
                <li><a href="#evaluation">Data Kamar Mahasiswa</a></li>
                {{-- <li><a href="#sakit">Data Mahasiswa Sakit</a></li>
                <li><a href="#alergi">Data Mahasiswa Alergi</a></li> --}}
                <li><a href="#dokumen">Dokumen</a></li>
              </ul>
            </li>

            {{-- <li><a class="nav-link scrollto" href="#kritik">Kritik & Saran</a></li> --}}
            <li><a class="nav-link scrollto" href="login"><button type="button" class="btn btn-warning">Login</button></a></li>
      ...
      <div class="row icon-boxes">
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">Asrama IT Del</a></h4>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="300">
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">Visi Misi Asrama</a></h4>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">Data Kamar Asrama</a></h4>
        ...
        <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="500">
          <div class="icon-box">
            ...
            <h4 class="title"><a href="">Aturan Asrama</a></h4>
  ...
  <section id="mate" class="cta">
    <div class="container" data-aos="zoom-in">
      <div class="text-center">
        ...
        <a class="cta-btn" href="#">Lihat kamar</a>
      </div>
    </div>
